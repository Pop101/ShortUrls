...
var Detector = function(){
	...
	var s = document.createElement("SPAN");
        d.setAttribute('style', 'opacity: 0; filter: alpha(opacity=0)'); //if it stops while running do not show it. // by Karoly Boda
	d.appendChild(s);
	d.style.fontFamily = "thisfontdoesnotexist";	//font for the parent element DIV.
	s.style.fontFamily = "thisfontdoesnotexist";	//use some bullshit as a comparator, then it will be replaced with the default font. // by Karoly Boda
